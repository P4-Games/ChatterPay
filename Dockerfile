...
ARG NEXT_PUBLIC_GCP_BUCKET_BASE_URL
...
ARG POLYMARKET_CLOB_API_URL
ARG POLYMARKET_ADAPTER_AUTH_TOKEN
ARG NEXT_PUBLIC_POLYMARKET_WS_URL
ARG CARDANO_STAKING_BFF_SECRET
...
ENV NEXT_PUBLIC_GCP_BUCKET_BASE_URL $NEXT_PUBLIC_GCP_BUCKET_BASE_URL
...
ENV POLYMARKET_CLOB_API_URL $POLYMARKET_CLOB_API_URL
ENV POLYMARKET_ADAPTER_AUTH_TOKEN $POLYMARKET_ADAPTER_AUTH_TOKEN
ENV NEXT_PUBLIC_POLYMARKET_WS_URL $NEXT_PUBLIC_POLYMARKET_WS_URL
ENV CARDANO_STAKING_BFF_SECRET $CARDANO_STAKING_BFF_SECRET
