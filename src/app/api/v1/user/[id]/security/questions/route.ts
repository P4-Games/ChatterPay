...
import { getSecurityQuestionsCatalog } from 'src/app/api/services/security/security-service'
...
export async function GET(req: NextRequest, { params }: { params: IParams }) {
  ...
  try {
    ...
    const result = await getSecurityQuestionsCatalog(phoneNumber)
    ...
    return NextResponse.json(
      { ok: false, message: 'Error getting security questions' },
