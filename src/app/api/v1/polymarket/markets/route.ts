...
import { getMarkets } from 'src/app/api/services/polymarket/polymarket-service'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const result = await getMarkets(params || undefined)
    ...
    return NextResponse.json(
      { ok: false, message: 'Error fetching markets' },
