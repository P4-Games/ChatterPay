...
const TEAM_MEMBERS = [
  {
    ...
    description: 'Financial technology expert with extensive experience in digital payment solutions.',
  ...
  },
  {
    ...
    description: 'Blockchain specialist with extensive experience in secure payment systems and fintech innovation.',
...
const STORY_PHOTOS = [
  '/assets/images/about-us/founders.jpg',
];
...
export default function AboutUsView() {
  ...
  const getFounderBio = (name: string) => {
    if (name === 'Martín Pefaur') {
      return t('aboutUs.founders.martin', 
    ...
    if (name === 'Tomás Di Mauro') {
      return t('aboutUs.founders.tomas', 
    ...
    return t('aboutUs.founders.diego', 
          ...
          <Container>
            ...
            >
              ...
              <Typography sx={{ maxWidth: 720, mx: 'auto', color: 'text.secondary' }}>
                {t('aboutUs.hero.description', 'ChatterPay is revolutionizing the way people send money by combining secure payments with the most used messaging app in the world. Our mission is to make crypto simple, in order to onboard the next billion users.')}
              </Typography>
            </m.div>
          </Container>
        </Box>
              ...
              <Grid xs={12} md={5}>
                ...
                >
                  ...
                  <Typography sx={{ color: 'text.secondary', mb: 2 }}>
                    {t('aboutUs.story.text1', 'Founded in 2024 at The Level Up Hackathon by Ethereum Argentina, where we won 1st prize in the Keystore track and were the most voted team in Quadratic Funding. We also won at Ethereum Uruguay and ICP Chain Fusion Hackathon BA.')}
                  </Typography>
                  
                  <Typography sx={{ color: 'text.secondary', mb: 2 }}>
                    {t('aboutUs.story.text2', 'During these hackathons, we iterated the product based on feedback and early users. We were then selected for the Scroll Open Campus program in Kuala Lumpur, Malaysia.')}
                  </Typography>
                  
                  <Typography sx={{ color: 'text.secondary' }}>
                    {t('aboutUs.story.text3', 'Malaysia is where we plan to start our launch campaigns and continue our mission of making crypto payments simple and accessible to everyone.')}
                  </Typography>
                </m.div>
              </Grid>
                      ...
                      <Card sx={{ 
                        ...
                        <Avatar
                          ...
                          sx={{ 
                            ...
                            height: 100, 
                            mb: 2,
                            boxShadow: (themeObj) => `0 8px 16px 0 ${alpha(themeObj.palette.grey[500], 0.16)}`
                          }}
                        />
        ...
        >
          <Container>
            ...
            >
              ...
              >
                {t('aboutUs.contact.description', 'We\'d love to hear from you. Get in touch with our team for any inquiries, feedback, or support needs. You can reach us via email at')} <Box component="span" sx={{ fontWeight: 'bold' }}>{CONTACT_EMAIL}</Box>
              </Typography>
            </m.div>
