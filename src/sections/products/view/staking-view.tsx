          ...
          <Container>
            ...
            >
              ...
              <Typography variant='body2' sx={{ mb: 3, color: 'text.disabled' }}>
                🚧 This section is under construction — stay tuned for staking rewards and
                tutorials.
              </Typography>

              <Typography sx={{ maxWidth: 720, mx: 'auto', color: 'text.secondary' }}>
                Earn while supporting the network. Stake your assets directly from ChatterPay with
