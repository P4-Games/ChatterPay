...
docker build \
  ...
  --build-arg NEXT_PUBLIC_GCP_BUCKET_BASE_URL="$NEXT_PUBLIC_GCP_BUCKET_BASE_URL" \
  ...
  --build-arg CARDANO_STAKING_BFF_SECRET="$CARDANO_STAKING_BFF_SECRET" \
  ...
  --build-arg NEXT_PUBLIC_DEFAULT_CHAIN_ID="$NEXT_PUBLIC_DEFAULT_CHAIN_ID" \
  --build-arg NEXT_PUBLIC_SECURITY_RECOVERY_QUESTIONS_COUNT="$NEXT_PUBLIC_SECURITY_RECOVERY_QUESTIONS_COUNT" \
  --build-arg NEXT_PUBLIC_SECURITY_PIN_LENGTH="$NEXT_PUBLIC_SECURITY_PIN_LENGTH" \
